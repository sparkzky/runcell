...
/// The Initdata specification defines the key data structures and algorithms
/// for injecting any well-defined data from an untrusted host into a TEE
/// (Trusted Execution Environment). To guarantee the integrity of the data,
/// either the hostdata capability of TEE evidence or the (v)TPM dynamic
/// measurement capability will be utilized. And its format looks like as below:
/// ```toml
/// algorithm = "sha384"
/// version = "0.1.0"
///
...
/// Decodes a base64-encoded gzipped initdata document to its raw TOML
/// representation.
...
/// The argument `initdata_annotation` is a Standard base64 encoded string
/// containing a TOML formatted content. This function decodes the base64
/// string, parses the TOML content into an InitData structure.
