...
use crate::{annotations, container::ContainerType};
...
/// "/var/lib/kubelet/pods/<id>/volumes/kubernetes.io~empty-dir/<volumeMount
/// name>" to "/<mount-point>".
...
///
/// This function is expected to be called only when the container type is
/// "PodContainer".
...
mod tests {
    ...
    fn test_is_watchable_mount() {
        ...
        let result = is_watchable_mount(
            "/var/lib/kubelet/pods/5f0861a0-a987-4a3a-bb0f-1058ddb9678f/volumes/kubernetes.\
             io~empty-dir/foobar",
        );
        assert!(!result);
