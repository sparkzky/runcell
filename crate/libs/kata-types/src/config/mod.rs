...
pub use self::{
    agent::Agent,
    hypervisor::{
        BootInfo, CloudHypervisorConfig, DragonballConfig, Factory, FirecrackerConfig,
        HYPERVISOR_NAME_DRAGONBALL, HYPERVISOR_NAME_FIRECRACKER, HYPERVISOR_NAME_QEMU, Hypervisor,
        QemuConfig, RemoteConfig,
    },
};

mod runtime;
pub use self::{
    agent::AGENT_NAME_KATA,
    runtime::{RUNTIME_NAME_VIRTCONTAINER, Runtime, RuntimeVendor},
};
...
impl TomlConfig {
    ...
    ///
    /// If `config_file` is valid, it will used, otherwise a built-in default
    /// path list will be scanned.
    ...
    ///
    /// Configuration file is probed according to the default configuration file
    /// list default::DEFAULT_RUNTIME_CONFIGURATIONS.
    ...
    /// Get agent-specfic kernel parameters for further Hypervisor config
    /// revision
    ...
    /// Probe configuration file according to the default configuration file
    /// list.
...
impl KataConfig {
    ...
    ///
    /// The default Kata configuration information is loaded from system
    /// configuration file.
    ...
    ///
    /// The active Kata configuration information is default configuration
    /// information patched with tunable configuration information from
    /// annotations.
