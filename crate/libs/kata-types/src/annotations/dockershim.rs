...
//! Copied from k8s.io/pkg/kubelet/dockershim/docker_service.go, used to
//! identify whether a docker container is a sandbox or a regular container,
//! will be removed after defining those as public fields in dockershim.

///  ContainerTypeLabelKey is the container type (podsandbox or container) of
/// key.
