...
// SandboxCPU annotations are based on the initial CPU configuration for the
// sandbox. This is calculated as the sum of container CPU resources, optionally
// provided by Kubelet (introduced in 1.23) as part of the PodSandboxConfig
...
// SandboxMemory is the initial amount of memory associated with this sandbox.
// This is calculated as the sum of container memory, optionally provided by
// Kubelet (introduced in 1.23) as part of the PodSandboxConfig
