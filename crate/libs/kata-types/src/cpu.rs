...
impl LinuxContainerCpuResources {
    ...
    /// Get number of vCPUs to fulfill the CPU resource request, `None` means
    /// unconstrained.
...
impl TryFrom<&oci::LinuxCpu> for LinuxContainerCpuResources {
    ...
    fn try_from(value: &oci::LinuxCpu) -> Result<Self, Self::Error> {
        ...
        // If quota is -1, it means the CPU resource request is unconstrained. In that
        // case, we don't currently assign additional CPUs.
