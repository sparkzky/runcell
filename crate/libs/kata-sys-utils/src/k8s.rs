...
//!
//! This module depends on kubelet internal implementation details, a better way
//! is needed to detect K8S EmptyDir medium type from `oci::spec::Mount`
//! objects.
...
/// Check whether the given path is a kubernetes empty-dir volume of medium
/// "default".
///
